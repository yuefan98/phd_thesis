...
mkdir('../dataset/raw_data', output_folder);

import com.comsol.model.*
import com.comsol.model.util.*
ModelUtil.showProgress(true);

COMSOL_MODEL_FILE = '../P2D-NLEIS_revised_final.mph';
PARAMETER_FILE = '../dataset/model_runs_512_10239.txt';
...
for j = START:STOP
    ...
    OUTPUT_FILE_NAME = ['../dataset/raw_data/' output_folder '/run-' num2str(j) '.txt'];
